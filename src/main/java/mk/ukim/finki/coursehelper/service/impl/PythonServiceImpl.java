...
//
//    public PythonServiceImpl(RestTemplate rest,
...
//
//    @Override
//    public TaskResponseDTO processAi(ProcessAiRequestDTO request) {
//        String url = pythonBaseUrl + "/api/process-ai";
//        HttpHeaders headers = new HttpHeaders();
//        headers.setContentType(MediaType.APPLICATION_JSON);
//        HttpEntity<ProcessAiRequestDTO> entity = new HttpEntity<>(request, headers);
//
//        ResponseEntity<TaskResponseDTO> resp = rest.exchange(
//                url,
//                HttpMethod.POST,
//                entity,
